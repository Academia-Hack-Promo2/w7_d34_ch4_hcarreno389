...
-- -----------------------------------------------------
-- Table `mybank`.`Operaciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mybank`.`Operaciones` (
  `idOperacion` INT NOT NULL,
  `tipo` VARCHAR(45) NOT NULL COMMENT '			',
  `cuenta_destino` INT(20) NULL,
  `cuenta_origen` INT(20) NULL,
...
-- -----------------------------------------------------
-- Table `mybank`.`cuentas_has_Operaciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mybank`.`cuentas_has_Operaciones` (
  `cuentas_idcuentas` INT NOT NULL,
  `Operaciones_idOperacion` INT NOT NULL,
  PRIMARY KEY (`cuentas_idcuentas`, `Operaciones_idOperacion`),
  INDEX `fk_cuentas_has_Operaciones_Operaciones1_idx` (`Operaciones_idOperacion` ASC),
  INDEX `fk_cuentas_has_Operaciones_cuentas1_idx` (`cuentas_idcuentas` ASC),
  CONSTRAINT `fk_cuentas_has_Operaciones_cuentas1`
    FOREIGN KEY (`cuentas_idcuentas`)
    REFERENCES `mybank`.`cuentas` (`idcuentas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cuentas_has_Operaciones_Operaciones1`
    FOREIGN KEY (`Operaciones_idOperacion`)
    REFERENCES `mybank`.`Operaciones` (`idOperacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mybank`.`mybank` (
  ...
  `clientes` VARCHAR(45) NULL DEFAULT NULL,
  `clientes_idclientes` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mybank`.`depositos` (
  ...
  `nº_cuenta_destino` INT(20) NULL DEFAULT NULL,
  `clientes_idclientes` INT NOT NULL,
